...
const kungya = {
  ...
  datas: [
    ...
    {name:"바나나",interval:10,limit:3000,init:120},
    {name:"망고",interval:15,limit:3000,init:130},
    {name:"고구마",interval:15,limit:3000,init:140},
    {name:"사과",interval:50,limit:5000,init:500},
    {name:"무",interval:15,limit:3000,init:150},
    {name:"완두",interval:20,limit:3500,init:160},
    {name:"용과"},
    {name:"완계"},
    {name:"라즈베리"},
    {name:"주먹밥"},
    {name:"구아바룽",interval:20,limit:3500,init:200},
    {name:"당근룽",interval:25,limit:4000,init:200},
    {name:"레몬룽",interval:25,limit:4000,init:200},
    {name:"백합룽"}
  ],
